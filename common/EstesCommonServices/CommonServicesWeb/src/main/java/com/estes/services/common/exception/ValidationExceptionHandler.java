...
public class ValidationExceptionHandler {
	...
	protected ResponseEntity<?> handleAppException(ValidationException ex, WebRequest request)
	{
		try{
			ESTESLogger.log(ESTESLogger.ERROR, "at class - "+ex.getStackTrace()[0].getClassName(), ", method : "+ex.getStackTrace()[0].getMethodName(),
