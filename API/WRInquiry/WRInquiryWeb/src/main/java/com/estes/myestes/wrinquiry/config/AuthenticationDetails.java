...
import com.estes.framework.logger.ESTESLogger;
 ...
 /*** 
  * To retrieve user authentication authorized informations  *
  */
...
public class AuthenticationDetails  {
	...
	public AuthenticationDetails(){
		...
		try {
			...
			//ex.printStackTrace();
			ESTESLogger.log(ESTESLogger.DEBUG, getClass(),"AuthenticationDetails()", ex.getMessage());
			ESTESLogger.log(ESTESLogger.DEBUG,getClass(),"AuthenticationDetails() constructor","User is not authenticated: Authentication object is "+auth);
		}
	}
