...
public class TemplateHeadMapper implements  RowMapper<TemplateHead>{

	@Override
	public TemplateHead mapRow(ResultSet rs, int rowNum) throws SQLException {
		
		TemplateHead draft = new TemplateHead();
		...
		draft.setBolDate(EstesUtil.formatDate(EstesUtil.removeNonDigit(bolDate),"MMddyyyy"));
