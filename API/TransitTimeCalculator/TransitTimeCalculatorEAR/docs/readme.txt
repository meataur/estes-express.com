...
This is the EAR container for all Estes transittimecalculator web applications.
...
J2SDK 1.8+
Maven-3.5.0:
Refer to the setup.txt document for information regarding Maven web projects
...
See buildNumber.properties file in parent project root
