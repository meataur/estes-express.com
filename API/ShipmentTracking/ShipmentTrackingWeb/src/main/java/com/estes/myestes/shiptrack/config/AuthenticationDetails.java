...
public class AuthenticationDetails  {
	...
	public String toString() {
		return "AuthenticationDetails [isAuthenticated()=" + isAuthenticated() + ", getUsername()=" + getUsername()
				+ ", getAccountCode()=" + getAccountCode() + ", getAccountType()=" + getAccountType() + ", getRole()="
				+ getRole() + ", getHash()=" + getHash() + ", getSession()=" + getSession() + ", getRandom()="
				+ getRandom() + ", getAccessToken()=" + getAccessToken() + ", getTokenType()=" + getTokenType()
				+ ", getRemoteAddress()=" + getRemoteAddress() + ", getScope()="
				+ getScope() + "]";
	}
}
