package com.estes.myestes.profile.exceptionHandler;
...
public class RestErrorHandler {
    ...
    private List<ServiceResponse> processFieldErrors(List<FieldError> fieldErrors,List<ObjectError> objectErrors) {
        ...
        for (FieldError fieldError: fieldErrors) {
            ...
            errors.add(new ServiceResponse(fieldError.getField(), localizedErrorMessage));
        }
        for (ObjectError objectError: objectErrors) {
            String localizedErrorMessage = resolveLocalizedErrorMessage(objectError);
            errors.add(new ServiceResponse(objectError.getObjectName(), localizedErrorMessage));
        }
