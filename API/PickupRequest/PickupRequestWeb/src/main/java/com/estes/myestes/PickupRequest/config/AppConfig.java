...
@PropertySources({
	...
	@PropertySource("file:${myestes.config.dir}/PickupRequest/error_mapping.properties"),
	@PropertySource("file:${myestes.config.dir}/PickupRequest/application.properties")
})
@Import({ OAuth2ResourceServerConfig.class,MethodSecurityConfig.class,JpaConfig.class})
public class AppConfig {

	@Autowired
	private Environment env;
	 
	// define a bean for our exla dataSource
