package com.estes.myestes.PickupRequest.listener;
...
import com.estes.myestes.PickupRequest.util.AppConstant;
...
public class ContextListener implements ServletContextListener
{
	...
	{
		ESTESLogger.log(ESTESLogger.DEBUG,getClass(), ce.getSource().toString()+" Context Initialization", "");
	} // contextDestroyed
}